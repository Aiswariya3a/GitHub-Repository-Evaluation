...
def dashboard(): return render_template("dashboard.html", title="Evaluation Sessions")
...
def create_api():
    ...
    try: return jsonify(services().sessions.create_session(payload.get("name", ""), payload.get("description", ""))), 201
