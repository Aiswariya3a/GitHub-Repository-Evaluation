class AnalysisService:
    ...
    def save_result(self, repository_id, repository_data, evaluation, rubric_version_id):
        self.repositories.save_repository_evaluation(repository_id, repository_data, evaluation, rubric_version_id)
